...
public func runProc(_ cmd: String, args: [String], envs: [String:String] = [:], quoteArgs: Bool = true, read: ((String) -> ())? = nil) throws {
...
public func runProc(_ cmd: String, args: [String], envs: [String:String], quoteArgs: Bool, readStdin: ((String) -> ()), readStderr: ((String) -> ())) throws -> Int {
	var ienvs = [("PATH", pathFromShell),
	             ("HOME", ProcessInfo.processInfo.environment["HOME"]!),
	             ("LANG", "en_CA.UTF-8")]
	for e in envs {
